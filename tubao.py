...
while cap.isOpened():
    ...
    image_height, image_width, _ = np.shape(image1)
    ...
    if results.multi_hand_landmarks:
        ...
        pos_x = hand.landmark[0].x*image_width
        pos_y = hand.landmark[0].y*image_height
        cv2.putText(image,'Y',(int(pos_x),int(pos_y)),cv2.FONT_HERSHEY_SIMPLEX,3,(255,255,0),4,cv2.LINE_AA)
